...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  late bool isEmailVerifiedClone;
  Timer? timer;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    isEmailVerifiedClone = false;
  ...
  checkEmailVerified() async {
    ...
    if (isEmailVerified) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (ctx) => LoginScreenForm()),
      );
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Center(
                  child: Text(
                    'We have sent you a Email on  ${authFirebase.currentUser?.email}',
                    textAlign: TextAlign.center,
                  ),
                ),
              ),
